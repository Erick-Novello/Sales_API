package ericknovello.com.github.sales_api.security.jwt;

import ericknovello.com.github.sales_api.SalesApiApplication;
...
public class JwtService {
    ...
    public static void main(String[] args) {
        ConfigurableApplicationContext run = SpringApplication.run(SalesApiApplication.class);
        JwtService jwtService = run.getBean(JwtService.class);
        Users users = Users.builder().login("McLogin").build();
    ...
    public String generateToken(Users users) {
        long minutesExpire = Long.parseLong(this.jwtSecurityExpiration);
